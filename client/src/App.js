                ...
                <Card style={{zIndex: '2'}} className={classes.root} variant="outlined">
                    <CardContent>
                        ...
                        {!checkAnswer ? (
                            ...
                            <div style={{textAlign: 'center'}}>
                                { locations[randomLocation][0] === userGuess ? (<CheckIcon fontSize="large" style={{ color: 'green' }} />):(<ClearIcon fontSize="large" style={{ color: 'red' }}/>)}
                                <br />
                                ...
                                <form>
                                <div style={{textAlign: 'center'}}>
                                        <Button type="submit" variant="contained">Try Again</Button>
                                    </div>
                                </form>
                            </div>)}
                    </CardContent>                    
